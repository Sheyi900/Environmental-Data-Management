...
The panel function allows costomizing a plot, such as superimposing points, lines, text, and other objects.  For example, to add a diagonal line to the two panel xyplot, we use:
```
xyplot(y~x|z, data=d,
       panel=function(x, y, ...){
